      ...
      <Head>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "Organization",
            "name": "Fundación Choyün",
            "url": "https://www.tusitio.com",
            "logo": "https://drive.google.com/uc?export=view&id=1E0gFkqUW2mDrGoZ0GCxOv9njBR6mNXc6",
            "sameAs": [
              "https://web.facebook.com/fundacionchoyun?locale=es_LA",
              "https://www.youtube.com/@fundacionchoyun6663",
              "https://www.instagram.com/fundacion.choyun/?hl=es"
            ],
            "contactPoint": {
              "@type": "ContactPoint",
        ...
        <article className='grid grid-cols-2 gap-x-6 mt-9 px-28'>
          <div>
            <ul>
              ...
              <li className='list-disc'>
                ...
                CONECTA, el área de talleres en línea de la fundación: Arte,
          ...
          <div>
            <p>
              ...
              crecimiento integral de las personas, fortalenciendo su carácter
